...
import { signInWithEmailAndPassword, signInAnonymously, signInWithCustomToken, setPersistence, browserSessionPersistence } from "firebase/auth";
    ...
    <main className="flex h-screen w-full items-center justify-center bg-gray-50 dark:bg-gray-900 px-4 font-inter">
      <div className="w-full max-w-lg p-8 space-y-8 bg-white rounded-2xl shadow-xl border border-gray-100 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-lg text-gray-500 dark:text-gray-400">Sign in to access the IAIN Admin Dashboard</p>
        </div>
        ...
        <div className="text-center text-sm text-gray-600 dark:text-gray-400">
          ...
          <a href="#" onClick={(e) => { e.preventDefault(); alert("Sign-up disabled in demo.") }} className="font-medium text-blue-600 hover:underline dark:text-blue-500">Sign up</a>
        </div>
