    ...
    try {
      ...
      const signIn = async () => {
        try {
          ...
          console.error("Initial Firebase Sign-in failed (Likely due to expired token/rules):", e);
          // We continue even if initial sign-in fails, as onAuthStateChanged will handle the final state.
        }
      };
