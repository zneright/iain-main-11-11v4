...
// NOTE: Assuming db and auth are correctly configured and exported from root firebase setup
...
// import { SignedIn, UserButton } from "@clerk/nextjs"; // Removed Clerk
...
const Navbar = () => {
  ...
  // ⭐ NEW STATE: To store the UID of the currently logged-in user
  ...
  // =================================================================
  // 🎯 STEP 1: LISTEN FOR AUTH STATE CHANGES TO GET UID
  // =================================================================
  useEffect(() => {
  ...
  // =================================================================
  // 🎯 STEP 2: FETCH NOTIFICATIONS BASED ON UID
  // =================================================================
          ...
          {isOpen && (
            <div className="absolute right-0 mt-2 w-64 rounded-xl bg-dark-2 shadow-lg border border-dark-3 animate-in fade-in slide-in-from-top-2">
              ...
              <ul className="max-h-60 overflow-y-auto text-sm text-gray-300">
                {currentUserId === null ? (
                  <li className="px-4 py-3 text-center text-gray-400">Please sign in.</li>
                ) : loading ? (
